...
```
https://cdn.jsdelivr.net/gh/oceanofanythingofficial/codemirror-5.63.3/`Your File Name`
```
### Example
### `codemirror.css`
```
https://cdn.jsdelivr.net/gh/oceanofanythingofficial/codemirror-5.63.3/lib/codemirror.css
```
### `codemirror.js`
```
https://cdn.jsdelivr.net/gh/oceanofanythingofficial/codemirror-5.63.3/lib/codemirror.js
```